...
export default function AdminCreateSubcategoryPage() {
    ...
    function getInputData(e) {
        ...
        // let value = name === "pic" ?  e.target.files[0].name : name === "status" ? (e.target.value === "1" ? true : false) : e.target.value
        //OR
        let value = ""
        if (name === "pic"){
            ...
            <div className="container-fluid my-3">
                <div className="row">
                    ...
                    <div className="col-lg-9">
                        <h5 className='bg-primary p-2 text-light text-center'>Create Subcategory
